...
public abstract class UPMAuthenticationAuthorizationWSSkeletonCallbackHandler {
    ...
    public void receiveResultremoveUser(
            sos.t3.a32.library.client.UPMAuthenticationAuthorizationWSSkeletonStub.RemoveUserResponseE result) {
    }
    ...
    public void receiveResultaddUser(
            sos.t3.a32.library.client.UPMAuthenticationAuthorizationWSSkeletonStub.AddUserResponse result) {
    }
    ...
    public void receiveResultexistUser(
            sos.t3.a32.library.client.UPMAuthenticationAuthorizationWSSkeletonStub.ExistUserResponseE result) {
    }
    ...
    public void receiveResultlogin(
            sos.t3.a32.library.client.UPMAuthenticationAuthorizationWSSkeletonStub.LoginResponse result) {
    }
    ...
    public void receiveResultchangePassword(
            sos.t3.a32.library.client.UPMAuthenticationAuthorizationWSSkeletonStub.ChangePasswordResponseE result) {
    }
