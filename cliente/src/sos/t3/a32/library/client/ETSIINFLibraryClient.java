...
public class ETSIINFLibraryClient {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            stub1_1._getServiceClient().engageModule("addressing");
            stub1_1._getServiceClient().getOptions().setManageSession(true);
            ...
            responseAdduser = stubAdmin.addUser(adduser);
            System.out.println(
                    "Intentando crear usuario 'admin' (false):\t" + responseAdduser.get_return().getResponse());

            adduser.getArgs0().setUsername("Usuario1");
            responseAdduser = stubAdmin.addUser(adduser);
            System.out.println(
                    "Intentando crear usuario 'Usuario1' (false):\t" + responseAdduser.get_return().getResponse());
            ...
            System.out
                    .println("Iniciado sesion 'Usuario1', " + pwd1 + ":\t" + responseLogin.get_return().getResponse());

            responseLogin = stub1.login(login);
            System.out.println("Iniciado sesion (de nuevo, misma instancia)'Usuario1', " + pwd1 + ":\t"
                    + responseLogin.get_return().getResponse());

            login.getArgs0().setPwd(pwd2);
            responseLogin = stub1.login(login);
            System.out.println("Iniciado sesion (misma instancia contraseña incorrecta)'Usuario1', " + pwd2 + ":\t"
                    + responseLogin.get_return().getResponse());

            login.getArgs0().setPwd(pwd1);
            responseLogin = stub1_1.login(login);
            System.out.println("Iniciado sesion (distinta instancia)'Usuario1', " + pwd1 + ":\t"
                    + responseLogin.get_return().getResponse());

            login.getArgs0().setName("Usuario2");
            login.getArgs0().setPwd(pwd2);
            responseLogin = stub1.login(login);
            System.out.println("Iniciado sesion (instancia logeada con Usuario 1)'Usuario2', " + pwd2 + " (false):\t"
                    + responseLogin.get_return().getResponse());
            ...
            System.out
                    .println("Iniciado sesion 'Usuario2', " + pwd2 + ":\t" + responseLogin.get_return().getResponse());

            login.getArgs0().setName("Usuario3");
            login.getArgs0().setPwd(pwd3);
            responseLogin = stub3.login(login);
            System.out
                    .println("Iniciado sesion 'Usuario3', " + pwd3 + ":\t" + responseLogin.get_return().getResponse());
            ...
            System.out.println("Cierre sesion 'Usuario1' en la misma instancia (false):\t"
                    + responseLogout.get_return().getResponse());

            responseLogout = stub1_1.logout(logout);
            System.out.println(
                    "Cierre sesion 'Usuario1' en otra instancia:\t" + responseLogout.get_return().getResponse());

            responseLogout = stub1_1.logout(logout);
            System.out.println("Cierre sesion 'Usuario1' en la misma otra instancia (false):\t"
                    + responseLogout.get_return().getResponse());
            ...
            System.out.println("Cambiando pwd de 'User2' de: " + pwd2 + "a 'patata':\t"
                    + responseChangepwd.get_return().getResponse());

            responseChangepwd = stub3.changePassword(changePassword);
            System.out.println("Cambiando pwd de 'User3' de: " + pwd2 + "a 'patata' (false):\t"
                    + responseChangepwd.get_return().getResponse());
            ...
            responseLogin = stub2.login(login);
            System.out.println("Iniciado sesion 'Usuario2' con nueva contraseña 'patata':\t"
                    + responseLogin.get_return().getResponse());

            login.getArgs0().setPwd(pwd2);
            responseLogin = stub1.login(login);
            System.out.println("Iniciado sesion 'Usuario2' con antigua contraseña '" + pwd2 + "'(false):\t"
                    + responseLogin.get_return().getResponse());
            ...
            while (i < 3) {
                ...
                System.out.println("Añadiendo ejemplar " + (i + 1) + " de 'Libro001', ISSN = 0001, autores = " + author1
                        + ":\t" + responseAddbook.get_return().getResponse());
            ...
            while (i < 3) {
                ...
                System.out.println("Añadiendo ejemplar " + (i + 1) + " de 'Libro00" + j + "'', ISSN = 000" + j
                        + ", autores = " + author2 + ":\t" + responseAddbook.get_return().getResponse());
            ...
            System.out.println("Añadiendo ejemplar 1 de 'Libro00" + j + "'', ISSN = 000" + j + ", autores = " + author3
                    + ":\t" + responseAddbook.get_return().getResponse());
            ...
            System.out.println("Añadiendo ejemplar 1 de 'Libro00'" + j + "'', ISSN = 000" + j + ", autores = " + authors
                    + ":\t" + responseAddbook.get_return().getResponse());
            ...
            System.out.println("Intentando pedir lista de libros sin iniciar sesion(false):\t"
                    + responselistbooks.get_return().getResult());
            ...
            System.out.println("Intentando pedir lista de libros sin iniciar sesion(false):\t"
                    + responsebooksfromauthor.get_return().getResult());
            ...
            System.out.println("Intentando pedir prestado sin iniciar sesion (false):\t"
                    + responseborrowbook.get_return().getResponse());
            ...
            responseborrowbook = stub2.borrowBook(borrowBook);
            System.out.println(
                    "Intentando pedir prestado libro ISSN: '0001' de nuevo extistiendo mas ejemplares (false):\t"
                            + responseborrowbook.get_return().getResponse());
            ...
            responseborrowbook = stub2.borrowBook(borrowBook);
            System.out.println(
                    "Intentando pedir prestado libro ISSN: '0002' de nuevo sin existir mas ejemplares (false):\t"
                            + responseborrowbook.get_return().getResponse());

            responseborrowbook = stub3.borrowBook(borrowBook);
            System.out.println(
                    "Intentando pedir prestado libro ISSN: '0002' de nuevo sin existir mas ejemplares desde otra instancia(false):\t"
                            + responseborrowbook.get_return().getResponse());
            ...
            responseborrowbook = stub2.borrowBook(borrowBook);
            System.out.println("Intentando pedir prestado libro ISSN: '9999' de nuevo sin existir el libro (false):\t"
                    + responseborrowbook.get_return().getResponse());
            ...
            System.out.println("Intentando pedir lista de libros prestados sin iniciar sesion (false):\t"
                    + responselListBorrowedBooks.get_return().getResult());

            responselListBorrowedBooks = stub3.listBorrowedBooks(listBorrowedBooks);
            System.out.println("Intentando pedir lista de libros prestados sin tener libros prestados:\t"
                    + responselListBorrowedBooks.get_return().getResult());
            ...
            System.out.println(
                    "Pidiendo lista de libros prestados:\t" + responselListBorrowedBooks.get_return().getResult());
            ...
            System.out.println("Intentando devolver libro sin iniciar sesion (false):\t"
                    + responseReturnBook.get_return().getResponse());

            responseReturnBook = stub3.returnBook(returnBook);
            System.out.println("Intentando devolver libro que no tiene prestado (false):\t"
                    + responseReturnBook.get_return().getResponse());
            ...
            returnBook.setArgs0("0002");
            responseReturnBook = stub1.returnBook(returnBook);
            System.out.println("Intentando devolver libro ISSN '0002' de nuevo (false):\t"
                    + responseReturnBook.get_return().getResponse());
            ...
            System.out.println("Intentando crear usuario 'Usuario99' desde usuario no admin (false):\t"
                    + responseAdduser.get_return().getResponse());

            responseAdduser = stubAdmin.addUser(adduser);
            System.out.println(
                    "Creado usuario 'Usuario99' desde instancia admin:\t" + responseAdduser.get_return().getResponse());
            ...
            System.out.println("Intentando borrar 'Usuario99' desde usuario no admin (false):\t"
                    + responseDeleteuser.get_return().getResponse());

            responseDeleteuser = stubAdmin.deleteUser(deleteUser);
            System.out.println("Intentando borrar 'Usuario99' desde usuario admin :\t"
                    + responseDeleteuser.get_return().getResponse());
            ...
            System.out.println("Intentando añadir ejemplar de 'Libro999', ISSN = 0999, autores = " + author1
                    + ", (no admin) (false):\t" + responseAddbook.get_return().getResponse());

            responseAddbook = stubAdmin.addBook(addBook);
            System.out.println("Intentando añadir ejemplar de 'Libro999', ISSN = 0999, autores = " + author1
                    + ", (admin):\t" + responseAddbook.get_return().getResponse());
            ...
            System.out.println("Intentando borrar libro de ISSN: '0999' desde usuario no admin:(false)\t"
                    + responseRemovebook.get_return().getResponse());

            responseRemovebook = stubAdmin.removeBook(removeBook);
            System.out.println("Intentando borrar libro de ISSN: '0999' desde usuario admin:\t"
                    + responseRemovebook.get_return().getResponse());
            ...
            responseDeleteuser = stubAdmin.deleteUser(deleteUser);
            System.out.println(
                    "Borrando 'Usuario1' con sesion cerrada:\t" + responseDeleteuser.get_return().getResponse());

            deleteUser.setArgs0(new Username());
            deleteUser.getArgs0().setUsername("Usuario2");
            responseDeleteuser = stubAdmin.deleteUser(deleteUser);
            System.out.println("Borrando 'Usuario2' con sesion abierta y libros prestados(false):\t"
                    + responseDeleteuser.get_return().getResponse());
            ...
            responseDeleteuser = stubAdmin.deleteUser(deleteUser);
            System.out.println(
                    "Borrando 'Usuario2' con sesion abierta:\t" + responseDeleteuser.get_return().getResponse());

            borrowBook.setArgs0("0002");
            responseborrowbook = stub2.borrowBook(borrowBook);
            System.out.println("Intentando pedir prestado libro ISSN: '0002 y usuario no existe (false)':\t"
                    + responseborrowbook.get_return().getResponse());
