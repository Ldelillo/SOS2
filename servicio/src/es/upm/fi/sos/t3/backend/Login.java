...
public class Login
    ...
    protected es.upm.fi.sos.t3.backend.xsd.LoginBackEnd localLogin;

    /*
     * This tracker boolean will be used to detect whether the user called the set
     * method
     ...
     * 
     * @return es.upm.fi.sos.t3.backend.xsd.LoginBackEnd
     */
    public es.upm.fi.sos.t3.backend.xsd.LoginBackEnd getLogin() {
        return localLogin;
    }
     ...
     * @param param Login
     */
    public void setLogin(es.upm.fi.sos.t3.backend.xsd.LoginBackEnd param) {
    ...
    public static class Factory {
        ...
        public static Login parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"login".equals(type)) {
                            ...
                            return (Login) es.upm.fi.sos.t3.backend.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es", "login")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setLogin(es.upm.fi.sos.t3.backend.xsd.LoginBackEnd.Factory.parse(reader));
