...
public class AddUser
    ...
    protected es.upm.fi.sos.t3.backend.xsd.UserBackEnd localUser;
     ...
     * 
     * @return es.upm.fi.sos.t3.backend.xsd.UserBackEnd
     */
    public es.upm.fi.sos.t3.backend.xsd.UserBackEnd getUser() {
        return localUser;
    }
     ...
     * @param param User
     */
    public void setUser(es.upm.fi.sos.t3.backend.xsd.UserBackEnd param) {
    ...
    public static class Factory {
        ...
        public static AddUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addUser".equals(type)) {
                            ...
                            return (AddUser) es.upm.fi.sos.t3.backend.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es", "user")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setUser(es.upm.fi.sos.t3.backend.xsd.UserBackEnd.Factory.parse(reader));
