...
public class AddUserResponse
    ...
    protected es.upm.fi.sos.t3.backend.xsd.AddUserResponseBackEnd local_return;
     ...
     * 
     * @return es.upm.fi.sos.t3.backend.xsd.AddUserResponseBackEnd
     */
    public es.upm.fi.sos.t3.backend.xsd.AddUserResponseBackEnd get_return() {
        return local_return;
    }
     ...
     * @param param _return
     */
    public void set_return(es.upm.fi.sos.t3.backend.xsd.AddUserResponseBackEnd param) {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addUserResponse".equals(type)) {
                            ...
                            return (AddUserResponse) es.upm.fi.sos.t3.backend.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.set_return(es.upm.fi.sos.t3.backend.xsd.AddUserResponseBackEnd.Factory.parse(reader));
