...
public class UPMAuthenticationAuthorizationWSSkeletonMessageReceiverInOut
        ...
        try {
            ...
            if ((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils
                ...
                if ("removeUser".equals(methodName)) {
                    ...
                    es.upm.fi.sos.t3.backend.RemoveUser wrappedParam = (es.upm.fi.sos.t3.backend.RemoveUser) fromOM(
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext), removeUserResponse21, false,
                ...
                if ("addUser".equals(methodName)) {
                    ...
                    es.upm.fi.sos.t3.backend.AddUser wrappedParam = (es.upm.fi.sos.t3.backend.AddUser) fromOM(
                            msgContext.getEnvelope().getBody().getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext), addUserResponse23, false,
                            new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                    "addUser"));
                } else
                ...
                if ("existUser".equals(methodName)) {
                    ...
                    es.upm.fi.sos.t3.backend.ExistUser wrappedParam = (es.upm.fi.sos.t3.backend.ExistUser) fromOM(
                            msgContext.getEnvelope().getBody().getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext), existUserResponse25, false,
                            new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                    "existUser"));
                } else
                ...
                if ("login".equals(methodName)) {
                    ...
                    es.upm.fi.sos.t3.backend.Login wrappedParam = (es.upm.fi.sos.t3.backend.Login) fromOM(
                            msgContext.getEnvelope().getBody().getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext), loginResponse27, false,
                            new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                    "login"));
                } else
                ...
                if ("changePassword".equals(methodName)) {
                    ...
                    es.upm.fi.sos.t3.backend.ChangePassword wrappedParam = (es.upm.fi.sos.t3.backend.ChangePassword) fromOM(
                            msgContext.getEnvelope().getBody().getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext), changePasswordResponse29, false,
                            new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                    "changePassword"));
    ...
    private org.apache.axiom.om.OMElement toOM(es.upm.fi.sos.t3.backend.RemoveUserResponse param,
    ...
    private org.apache.axiom.om.OMElement toOM(es.upm.fi.sos.t3.backend.ExistUserResponse param,
            boolean optimizeContent)
            throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(es.upm.fi.sos.t3.backend.ChangePasswordResponse param,
            boolean optimizeContent)
            throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
            es.upm.fi.sos.t3.backend.RemoveUserResponse param, boolean optimizeContent,
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    .addChild(param.getOMElement(es.upm.fi.sos.t3.backend.RemoveUserResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
            es.upm.fi.sos.t3.backend.AddUserResponse param, boolean optimizeContent,
            javax.xml.namespace.QName methodQName)
            throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            ...
            emptyEnvelope.getBody()
                    .addChild(param.getOMElement(es.upm.fi.sos.t3.backend.AddUserResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
            es.upm.fi.sos.t3.backend.ExistUserResponse param, boolean optimizeContent,
            javax.xml.namespace.QName methodQName)
            throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            ...
            emptyEnvelope.getBody()
                    .addChild(param.getOMElement(es.upm.fi.sos.t3.backend.ExistUserResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
            es.upm.fi.sos.t3.backend.LoginResponse param, boolean optimizeContent,
            javax.xml.namespace.QName methodQName)
            throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            ...
            emptyEnvelope.getBody()
                    .addChild(param.getOMElement(es.upm.fi.sos.t3.backend.LoginResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
            es.upm.fi.sos.t3.backend.ChangePasswordResponse param, boolean optimizeContent,
            javax.xml.namespace.QName methodQName)
            throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            ...
            emptyEnvelope.getBody()
                    .addChild(param.getOMElement(es.upm.fi.sos.t3.backend.ChangePasswordResponse.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(
        ...
        try {
            ...
            if (es.upm.fi.sos.t3.backend.RemoveUserResponse.class.equals(type)) {
                ...
                return es.upm.fi.sos.t3.backend.RemoveUserResponse.Factory
            ...
            if (es.upm.fi.sos.t3.backend.ExistUserResponse.class.equals(type)) {
                ...
                return es.upm.fi.sos.t3.backend.ExistUserResponse.Factory
                        .parse(param.getXMLStreamReaderWithoutCaching());
            ...
            if (es.upm.fi.sos.t3.backend.ChangePasswordResponse.class.equals(type)) {
                ...
                return es.upm.fi.sos.t3.backend.ChangePasswordResponse.Factory
                        .parse(param.getXMLStreamReaderWithoutCaching());
